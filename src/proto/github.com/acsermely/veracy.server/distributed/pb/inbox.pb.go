...
func (x *InboxMessage) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
func (x *InboxMessage) GetSender() string {
	if x != nil {
		return x.Sender
	}
	return ""
...
func (x *InboxResponse) GetReceived() bool {
	if x != nil {
		return x.Received
	}
	return false
...
var file_inbox_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x69, 0x6e, 0x62, 0x6f, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70,
	0x62, 0x22, 0x72, 0x0a, 0x0c, 0x49, 0x6e, 0x62, 0x6f, 0x78, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x18,
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x2b, 0x0a, 0x0d, 0x49, 0x6e, 0x62, 0x6f, 0x78, 0x52, 0x65,
	...
	0x2f, 0x61, 0x63, 0x73, 0x65, 0x72, 0x6d, 0x65, 0x6c, 0x79, 0x2f, 0x76, 0x65, 0x72, 0x61, 0x63,
	0x79, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x64, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62,
	0x75, 0x74, 0x65, 0x64, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_inbox_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_inbox_proto_goTypes = []any{
	(*InboxMessage)(nil),  // 0: pb.InboxMessage
	(*InboxResponse)(nil), // 1: pb.InboxResponse
}
