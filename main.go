...
func initServer(port string) *http.Server {
	...
	mux.HandleFunc("/sendMessages", handlers.WalletMiddleware(handlers.SendMessage))
	mux.HandleFunc("/savedMessages", handlers.WalletMiddleware(handlers.MessageSaved))
